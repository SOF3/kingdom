...
class ElementDt(internal val dom: DomElementImpl) : ComplexInline by ComplexInlineImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementDt.() -> Unit) = apply(fn)
