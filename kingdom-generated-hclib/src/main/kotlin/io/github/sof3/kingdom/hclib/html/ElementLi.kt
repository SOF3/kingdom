...
class ElementLi(internal val dom: DomElementImpl) : ComplexFlow by ComplexFlowImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementLi.() -> Unit) = apply(fn)
