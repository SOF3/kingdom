...
class ElementDl(internal val dom: DomElementImpl) : AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementDl.() -> Unit) = apply(fn)


	val dt get() = ElementDt(DomElementImpl(dom))
	val dd get() = ElementDd(DomElementImpl(dom))
