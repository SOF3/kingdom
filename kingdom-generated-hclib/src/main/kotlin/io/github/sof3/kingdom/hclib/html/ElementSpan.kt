...
class ElementSpan(internal val dom: DomElementImpl) : ComplexInline by ComplexInlineImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementSpan.() -> Unit) = apply(fn)
