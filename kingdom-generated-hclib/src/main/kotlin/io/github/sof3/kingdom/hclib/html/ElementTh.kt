...
class ElementTh(internal val dom: DomElementImpl) : ComplexFlow by ComplexFlowImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), AttrGroupCellhalign by AttrGroupCellhalignImpl(dom), AttrGroupCellvalign by AttrGroupCellvalignImpl(dom), DomElement {
	init {
		dom.element = this
	}
	...
	inline operator fun invoke(fn: ElementTh.() -> Unit) = apply(fn)
