...
class ElementOptgroup(internal val dom: DomElementImpl) : AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementOptgroup.() -> Unit) = apply(fn)

	var disabled: AttrTypeOptgroupDisabled? by DomAttributeAdapter("disabled", dom, null as AttrTypeOptgroupDisabled?)
