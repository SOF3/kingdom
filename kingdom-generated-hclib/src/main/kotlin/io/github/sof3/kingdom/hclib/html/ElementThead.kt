...
class ElementThead(internal val dom: DomElementImpl) : AttrGroupAttrs by AttrGroupAttrsImpl(dom), AttrGroupCellhalign by AttrGroupCellhalignImpl(dom), AttrGroupCellvalign by AttrGroupCellvalignImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementThead.() -> Unit) = apply(fn)
