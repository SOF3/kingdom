...
class ElementNoscript(internal val dom: DomElementImpl) : ComplexBlock by ComplexBlockImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementNoscript.() -> Unit) = apply(fn)
