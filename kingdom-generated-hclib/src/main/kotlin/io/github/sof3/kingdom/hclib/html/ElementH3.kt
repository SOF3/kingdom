...
class ElementH3(internal val dom: DomElementImpl) : ComplexInline by ComplexInlineImpl(dom), AttrGroupAttrs by AttrGroupAttrsImpl(dom), DomElement {
	...
	inline operator fun invoke(fn: ElementH3.() -> Unit) = apply(fn)
